angular.module('starter.services', [])
  ...
  .factory('Camera', ['$q', function($q) {
    ...
    .factory('CustomerService', function ($http, basicURL, UtilService, ServerRoot, $rootScope) {
        ...
        return {
          ...
          userWorkSign: function(position, type) {

            UtilService.showLoadingScreen();

            var queryData = {username: UtilService.getCurrentLoggedInUser().username, token: UtilService.getCurrentLoggedInUser().token, jd: "" + position.lng, wd: "" + position.lat, dizhi: '', leixing: type};
            console.debug(JSON.stringify(queryData));

            $http({
              url: ServerRoot + 'qiandao',
              data: queryData,
              method: 'POST'
            }).success(function (response, status, headers, config) {
            ...
            executeTask: function(url, taskId, lng, lat, address, createDate, companyName, comments, finished) {
              ...
              $http({
                url: ServerRoot + 'waiqin/shenpichuli',
                data: queryData,
                method: 'POST'
              }).success(function (response, status, headers, config) {
            ...
            searchCustomers: function ($scope, keyword) {
